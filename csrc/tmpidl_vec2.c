 ...
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Provide the 2D geometry sublibrary of libtmpl for IDL users.          *
 ******************************************************************************
 *  Author:     Ryan Maguire                                                  *
 *  Date:       March 9, 2022                                                 *
 ******************************************************************************/
...
extern void tmpidl_Vec2_Norm(int argc, void *argv[]);

/*  Function for computing the 2D Euclidean norm of a 2D array.               */
