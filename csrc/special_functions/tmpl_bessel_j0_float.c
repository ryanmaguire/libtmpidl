...
extern void tmpidl_Float_Bessel_J0(int argc, void *argv[]);

/*  IDL wrapper for the Bessel J0 function.                                   */
void tmpidl_Float_Bessel_J0(int argc, void *argv[])
{
...
#endif
    for (n = 0; n < size; ++n)
        y[n] = tmpl_Float_Bessel_J0(x[n]);
}
/*  End of tmpidl_Float_Bessel_J0.                                            */
