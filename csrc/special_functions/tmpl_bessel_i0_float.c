 ...
 ******************************************************************************
 *                           tmpidl_bessel_i0_float                           *
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Provides an IDL wrapper for single precision I0.                      *
 ******************************************************************************
 *  Author:     Ryan Maguire                                                  *
...
extern void tmpidl_Float_Bessel_I0(int argc, void *argv[]);

/*  IDL wrapper for the Bessel I0 function.                                   */
void tmpidl_Float_Bessel_I0(int argc, void *argv[])
{
    /*  Declare two float pointers, the input and output for IDL.             */
    float *x, *y;
...
#endif
    for (n = 0; n < size; ++n)
        y[n] = tmpl_Float_Bessel_I0(x[n]);
}
/*  End of tmpidl_Float_Bessel_I0.                                            */
